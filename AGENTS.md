...
| 图标 | Heroicons (Outline) | 与 Tailwind 风格统一的图标库 |
...
- `region` - 所在地区
- `about_me` - 个人描述
- `wechat` / `qq` / `weibo` / `github` / `qq_group` - 社交链接
...
```
标题|描述|链接|Heroicon图标名|颜色
```

示例：
```
ImgURL|开源免费的图床程序|https://imgurl.org/|photo|blue
...
5. 图标使用 Heroicons Outline 风格，通过 SVG 内联使用
