...
<aside class="w-full lg:w-80 flex-shrink-0">
    ...
    <div class="card p-6 mb-6">
        ...
        <div class="flex justify-center flex-wrap gap-3">
            ...
            <?php if (!empty($github)): ?>
            <a href="<?php echo esc_url($github); ?>" target="_blank" rel="nofollow" class="w-10 h-10 flex items-center justify-center bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors" title="GitHub">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
